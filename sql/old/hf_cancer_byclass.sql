...
--
-- 140-149.99: MALIGNANT NEOPLASM OF LIP, ORAL CAVITY, AND PHARYNX 
-- 150-159.99: MALIGNANT NEOPLASM OF DIGESTIVE ORGANS AND PERITONEUM 
-- 160-165.99: MALIGNANT NEOPLASM OF RESPIRATORY AND INTRATHORACIC ORGANS 
-- 170-176.99: MALIGNANT NEOPLASM OF BONE, CONNECTIVE TISSUE, SKIN, AND BREAST 
-- 179-189.99: MALIGNANT NEOPLASM OF GENITOURINARY ORGANS 
...
-- 235-238.99: NEOPLASMS OF UNCERTAIN BEHAVIOR
-- 239-239.99: NEOPLASMS OF UNSPECIFIED NATURE
--
--
SELECT
	COUNT(DISTINCT t.patient_id) AS "patient_count",
	COUNT(DISTINCT t.encounter_id) AS "encounter_count",
	t.cancer_class
FROM
	(
	SELECT
